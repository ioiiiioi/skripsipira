        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="index.php"><i class="menu-icon fa fa-laptop"></i>Admin Dashboard </a>
                    </li>
                ...
                <div class="header-menu">
                    <div class="header-left">
                      <ul class="nav navbar-nav navbar-right">
                         <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="label label-pill label-danger count" style="border-radius:10px;"></span> <i class="fa fa-bell"></i><span class="glyphicon glyphicon-bell" style="font-size:18px;"></span></a>
                    ...
                    <div style="margin-top: 10px; margin-left: 50px;">
                        <a href="../../command/selesai_session.php" class="btn btn-danger">
                            Log Out
                        </a>
                    </div>
                </div>

        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><span class="font-weight-bold text-info">KUSUMA</span> <span>MAHARDIKA</span></a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title ">Info RAB</strong>
                            </div>
                            <div class="card-body">
